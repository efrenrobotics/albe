...
const TARGET_DATE = new Date("2026-02-28T12:00:00-06:00"); // Feb 28, 2026 12:00 PM CT
...
export default function BirthdayPage() {
  ...
  return (
    <main className="fixed inset-0 flex flex-col items-center justify-center bg-warm-black">
      <BirthdayParticles />

      {/* Back link */}
      <Link
        href="/"
        className="absolute top-6 left-6 z-20 text-white/40 hover:text-white/70 transition-colors text-sm font-sans flex items-center gap-1.5"
      >
        <span>←</span>
        <span>Volver</span>
      </Link>
